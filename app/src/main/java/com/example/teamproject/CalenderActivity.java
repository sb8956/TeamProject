...
public class CalenderActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.show_selections:
                ...
                Toast.makeText(CalenderActivity.this, result, Toast.LENGTH_LONG).show();
                return true;
